            ...
            <div className="px-4 sm:px-6 md:px-8 mt-6 grid grid-cols-1 gap-6">
              {!selectedFacility && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Please upload facility data or select a facility to plan your deployment timeline.
                  </AlertDescription>
                </Alert>
              )}

              {!progress.financial && selectedFacility && (
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertTitle>Financial analysis not completed</AlertTitle>
                  <AlertDescription>
                    To ensure proper deployment planning, please complete your financial analysis first.
                    <Link href="/financial">
